...
import semmle.code.cpp.security.flowafterfree.FlowAfterFree2
import semmle.code.cpp.security.flowafterfree.UseAfterFree2
import UseAfterFreeTrace::PathGraph

module UseAfterFreeParam implements FlowFromFreeParamSig {
  predicate isSink = isUse/2;

  predicate isExcluded(DeallocationExpr dealloc, Expr e) { none() }

  predicate sourceSinkIsRelated(DataFlow::Node source, DataFlow::Node sink) { any() }
}
